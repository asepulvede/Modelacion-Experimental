...
%Se realiza otro cambio en le orden ya que los fijados deben ir al
%principio
%vars=[Hit Hi Me He Hr Hs Ms Mi];
vars= [Hit Hi Me He Hs Hr Ms Mi];

Range(5:6,:)= [Range4(6,:); Range4(5,:)];
...
%Se incrementa en un 20% la longitud del intervalo
%vars= [Hit Hi Me He Hs Hr Ms Mi];
Range(6,1)= Range(6,2)- (Range(6,2)-Range(6,1))*1.2;
Range(11,2)= Range(11,1) + (Range(11,2)-Range(11,1))*1.2;
Range(8,1)= Range(8,2) - (Range(8,2)-Range(8,1))*1.2;
Range(14,2)= Range(14,1) +(Range(14,2)-Range(14,1))*1.2;
Range(12,1)= Range(12,2) - (Range(12,2)-Range(12,1))*1.2;
